        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="createPaymentForm" action="<?php echo e(route('payments.store')); ?>" method="POST" enctype="multipart/form-data" novalidate>
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select class="form-control select2" id="purpose_id" name="purpose_id" style="width: 100%;" required>
                                    ...
                                    <?php $__currentLoopData = $purposes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purpose): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($purpose->id); ?>" <?php echo e(old('purpose_id') == $purpose->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" id="receipt_no" name="reciept_no" value="<?php echo e(old('reciept_no')); ?>" placeholder="Enter Receipt Number" required>
                                <?php $__errorArgs = ['reciept_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select class="form-control select2" id="brance_id" name="brance_id" style="width: 100%;" required>
                                    ...
                                    <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($branch->id); ?>" <?php echo e(old('brance_id') == $branch->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" id="date" name="date" placeholder="dd-mm-yy" value="<?php echo e(old('date')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" id="amount_in_words" name="amount_in_words" value="<?php echo e(old('amount_in_words')); ?>" placeholder="Amount in Words" required>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            window.location.href = "<?php echo e(route('payments.report')); ?>";
    ...
    <script>
        $(document).ready(function () {
            $('#brance_id').on('change', function () {
                ...
                if (branceId) {
                    $.ajax({
                        url: "<?php echo e(route('accounts.by.branch', '')); ?>/" + branceId,
                        type: "GET",
                        success: function (response) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\eaccounting\resources\views/admin/payment/index.blade.php ENDPATH**/ ?>