                ...
                <div class="col-md-2">
                    ...
                    <select class="form-select select2" id="expense_head_id" name="expense_head_id" required>
                        ...
                        @foreach ($expenseHeads as $eh)
                            <option value="{{ $eh->id }}" {{ $eh->id == old('expense_head_id') ? 'selected' : '' }}>
                ...
                <div class="col-md-2">
                    ...
                    <select class="form-select select2" id="brance_id" name="brance_id" required>
                        ...
                        @foreach ($brances as $brance)
                            <option value="{{ $brance->id }}" {{ $brance->id == old('brance_id') ? 'selected' : '' }}>
                                {{ $brance->name }}
                            </option>
                        @endforeach
                    </select>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-md-12">
                            <h4>Total Expenses: <span id="totalAmount">{{ number_format($totalAmount ?? 0, 2) }} TK</span></h4>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#export_excel').click(function(e) {
                ...
                let url = "{{ route('expenses.export.excel') }}" +
            ...
            $('#export_pdf').click(function(e) {
                ...
                let url = "{{ route('expenses.export.pdf') }}" +
                    "?from_date=" + encodeURIComponent(fromDate) +
                    "&to_date=" + encodeURIComponent(toDate) +
                    "&expense_head_id=" + encodeURIComponent(expense_head_id) +
                    "&brance_id=" + encodeURIComponent(brance_id) +
